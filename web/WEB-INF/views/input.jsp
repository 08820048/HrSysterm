...
<div class="container">
    ...
    <form class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control"  required  id="empName_add_input" name="empName" placeholder="请输入姓名">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="email" class="form-control" name="empEmail"  required  id="empEmail_add_input" placeholder="请输入Email">
            </div>
        </div>
        <div class="form-group">
            <span class="help-block">    </span>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select class="selectpicker" data-width="100%" id="department"   name="dId" title="请选择部门">
...
<%--        <a class="btn btn-lg btn-primary btn-block" id="emp_save_btn" href="${App_Path}/input"><span class="glyphicon glyphicon-save"></span>修改</a>--%>
        <button type="button"  id="emp_save_btn" class="btn btn-primary btn-lg btn-block"><span class="glyphicon glyphicon-save"></span>新增</button>
    </form>
</div>
